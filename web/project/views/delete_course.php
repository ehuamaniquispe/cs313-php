...
<body>
    ...
    <h1>Delete Course</h1>
        ...
        <form action="../courses/index.php" method="POST">
            ...
            <input type="text" name="course_name" id="course_name" required value="<?php if(isset($getCoursesInfoById[courses_name])){echo($getCoursesInfoById[courses_name]);}?>" readonly><br>
