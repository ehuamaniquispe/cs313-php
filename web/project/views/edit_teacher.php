...
<body>
    ...
    <h1>Edit Teacher</h1>
        ...
        <div class="form-group">  
            ...
            <input type="text" class="form-control" name="teacher_fname" id="teacher_fname" required value="<?php if(isset($getTeachersInfoById[teachers_fname])){echo($getTeachersInfoById[teachers_fname]);}?>"><br>
        </div>
        <div class="form-group">  
            <label for="teacher_lname">Last Name</label><br>
            <input type="text" class="form-control" name="teacher_lname" id="teacher_lname" required value="<?php if(isset($getTeachersInfoById[teachers_lname])){echo($getTeachersInfoById[teachers_lname]);}?>"><br>
        </div>
